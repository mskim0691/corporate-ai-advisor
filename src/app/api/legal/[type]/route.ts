...
// 기본 약관 내용
const DEFAULT_TERMS = `<h1>서비스 이용약관</h1>

<h2>제1조 (목적)</h2>
<p>이 약관은 이엑스이사일일(이하 "회사")가 제공하는 AI-GFC 서비스(이하 "서비스")의 이용조건 및 절차, 회사와 이용자의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.</p>

<h2>제2조 (정의)</h2>
<p>① "서비스"란 회사가 제공하는 AI 기반 법인 컨설팅 분석 서비스를 말합니다.</p>
<p>② "이용자"란 이 약관에 따라 회사가 제공하는 서비스를 이용하는 회원을 말합니다.</p>
<p>③ "회원"이란 회사에 개인정보를 제공하여 회원등록을 한 자로서, 회사의 정보를 지속적으로 제공받으며 서비스를 계속적으로 이용할 수 있는 자를 말합니다.</p>

<h2>제3조 (약관의 효력 및 변경)</h2>
<p>① 이 약관은 서비스 화면에 게시하거나 기타의 방법으로 회원에게 공지함으로써 효력이 발생합니다.</p>
<p>② 회사는 합리적인 사유가 발생할 경우 관련 법령에 위배되지 않는 범위 내에서 이 약관을 변경할 수 있으며, 변경된 약관은 제1항과 같은 방법으로 공지합니다.</p>

<h2>제4조 (서비스의 제공)</h2>
<p>① 회사는 다음과 같은 서비스를 제공합니다.</p>
<ul>
<li>AI 기반 기업 재무 분석 서비스</li>
<li>컨설팅 리포트 생성 서비스</li>
<li>비주얼 레포트 생성 서비스</li>
<li>기타 회사가 정하는 서비스</li>
</ul>
<p>② 서비스는 연중무휴, 1일 24시간 제공함을 원칙으로 합니다. 단, 시스템 점검 등의 필요에 의해 서비스가 일시 중단될 수 있습니다.</p>
...
<h2>제8조 (저작권의 귀속)</h2>
<p>① 서비스에 의해 생성된 분석 결과물의 저작권은 회사에 귀속됩니다.</p>
<p>② 이용자는 서비스를 통해 생성된 결과물을 개인적 또는 업무적 용도로 사용할 수 있습니다.</p>
...
<p>③ AI 분석 결과는 참고용으로 제공되며, 최종 의사결정은 이용자의 책임하에 이루어져야 합니다.</p>
...
const DEFAULT_PRIVACY = `<h1>개인정보처리방침</h1>

<p>이엑스이사일일(이하 "회사")는 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.</p>
...
<ul>
<li><strong>회원 가입 및 관리:</strong> 회원제 서비스 이용에 따른 본인확인, 개인식별, 불량회원의 부정이용 방지, 각종 고지·통지 등</li>
<li><strong>서비스 제공:</strong> AI 분석 서비스 제공, 맞춤형 서비스 제공, 본인인증 등</li>
<li><strong>결제 처리:</strong> 유료 서비스 이용 시 결제 처리</li>
</ul>
...
<li><strong>결제 시:</strong> 결제정보(결제수단, 결제금액 등)</li>
</ul>
...
<ul>
<li><strong>결제처리:</strong> 토스페이먼츠</li>
<li><strong>클라우드 서비스:</strong> Vercel, Supabase</li>
</ul>
...
<ul>
<li><strong>개인정보 보호책임자:</strong> 김민수</li>
<li><strong>연락처:</strong> 070-8064-8232</li>
<li><strong>이메일:</strong> privacy@ai-gfc.com</li>
</ul>
